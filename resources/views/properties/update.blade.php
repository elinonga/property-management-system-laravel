            ...
            <div class="row">
                ...
                <div class="col-md-8 column">
                    ...
                    <div class="submit-content">
                        ...
                        <form action="{{ route('view-property.update', $property->id)}}" id="new_post" enctype="multipart/form-data" name="new_post" method="POST" class="property-form" role="form">
                                ...
                                <div class="group-container row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group s-prop-title">
                                            ...
                                            <input type="text" id="title" class="form-control" name="title" required="" value="{{ $property->title }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group s-prop-area">
                                            ...
                                            <input type="text" id="area" class="form-control" name="area" value="{{ $property->area }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group s-prop-desc">
                                            ...
                                            <textarea id="textarea" name="desc" rows="10" required="" style="width: 100%;">{{ $property->desc }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group s-prop-price row">
                                            <div class="price col-md-4">
                                                ...
                                                <input type="text" id="price" class="form-control" value="{{ $property->price }}" name="price" required="">
                                            </div>
                                            <div class="price_label col-md-8">
                                                <label for="price_label">After price label (ex: "per month")</label>
                                                <input type="text" id="price_label" class="form-control" value="{{ $property->price_label }}" name="price_label">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group s-prop-bedrooms">
                                            ...
                                            <input type="text" id="bedrooms" class="form-control" value="{{ $property->bedrooms }}" name="bedrooms">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group s-prop-bathrooms">
                                            ...
                                            <input type="text" id="bathrooms" class="form-control" value="{{ $property->bathrooms }}" name="bathrooms">
                                        </div>
                                    </div>
                                ...
                                <div class="group-container row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group property_field_lot_area">
                                            ...
                                            <input type="text" id="property_field_lot_area" name="lot_area" class="form-control" value="{{ $property->lot_area }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group s-prop-property_field_year_built">
                                            ...
                                            <input type="text" id="property_field_year_built" name="year_built" class="form-control" value="{{ $property->year_built }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group s-prop-property_field_flooring">
                                            ...
                                            <input type="text" id="property_field_flooring" name="flooring" class="form-control" value="{{ $property->flooring }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group s-prop-property_field_garage_size">
                                            ...
                                            <input type="text" id="property_field_garage_size" name="garage_size" class="form-control" value="{{ $property->garage_size }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group s-prop-property_field_roofling">
                                            ...
                                            <input type="text" id="property_field_roofling" name="roofling" class="form-control" value="{{ $property->roofling }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group s-prop-property_field_parking">
                                            ...
                                            <input type="text" id="property_field_parking" name="parking" class="form-control" value="{{ $property->parking }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group s-prop-property_field_style">
                                            ...
                                            <input type="text" id="property_field_style" name="style" class="form-control" value="{{ $property->style }}">
                                        </div>
                                    </div>
                                ...
                                <div class="group-container row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group s-prop-address">
                                            ...
                                            <textarea id="address" class="form-control" name="address" rows="1" required="">{{ $property->address }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group s-prop-long">
                                            ...
                                            <input type="text" id="property_gmap_longitude" class="form-control" value="{{ $property->long }}" name="long">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group s-prop-lat">
                                            ...
                                            <input type="text" id="property_gmap_latitude" class="form-control" value="{{ $property->lat }}" name="lat">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="property_google_map">
                                            ...
                                            <div class="property_google_map_search">
                                                <input placeholder="Search your map" name="maps" value="{{ $property->maps }}" type="text" autocomplete="off" id="property_google_map_search_input">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="group-container row">
                                            <div class="col-md-12">
                                                <div class="form-group s-prop-video">
                                                    ...
                                                    <input type="text" id="_video_embedded" class="form-control" value="{{ $property->video }}" name="video">
                            ...
                            <div class="submit row" style="clear: both; margin-top: 25px;">
                                <div class="col-md-12">
                                    <input type="submit" class="btn btn-lg flat-btn" id="property_submit" value="Update Property">
